-- Hack to fix wrong dataformat Qbuzz
update pujopass set targetarrivaltime = targetarrivaltime||':00' where char_length(targetarrivaltime) = 5;
update pujopass set targetdeparturetime = targetdeparturetime||':00' where char_length(targetdeparturetime) = 5;
